...
from common.graph_utils import load_graphs, separate_graph_data
from algo.gin.graphcnn import GraphCNN
...
def main():
    ...
    graphs, num_classes = load_graphs(data_utils.get_data_path(args.dataset), args.degree_as_tag)

    # 10-fold cross validation. Conduct an experiment on the fold specified by args.fold_idx.
    train_graphs, test_graphs = separate_graph_data(graphs, args.seed, args.fold_idx)
